...
def addPreviewMaterialInterface(material: pxr.UsdShade.Material) -> bool:
    ...
    """
def addPrimvarShaderToPreviewMaterial(material: pxr.UsdShade.Material, surfaceInputName: str, primvarName: str, fallbackValue: pxr.Vt.Value = None) -> bool:
    """
...
def computeEffectivePreviewSurfaceShader(material: pxr.UsdShade.Material) -> pxr.UsdShade.Shader:
    ...
    """
def configureAssemblyHierarchy(prim: pxr.Usd.Prim) -> bool:
    """
    ...
    """
def configureComponentHierarchy(prim: pxr.Usd.Prim) -> bool:
    """
...
def configureStage(stage: pxr.Usd.Stage, defaultPrimName: str, upAxis: str, linearUnits: float, authoringMetadata: typing.Optional[str] = None) -> bool:
    pass
def connectPhysicsJoint(joint: pxr.UsdPhysics.Joint, body0: pxr.Usd.Prim, body1: pxr.Usd.Prim, frame: JointFrame, axis: pxr.Gf.Vec3f) -> None:
    """
    ...
    Args:
        ...
        axis: The axis of the joint.
    """
def connectPrimvarShader(shaderInput: pxr.UsdShade.Input, primvarName: str, fallbackValue: pxr.Vt.Value = None) -> bool:
    """
...
def defineCamera(prim: pxr.Usd.Prim, cameraData: pxr.Gf.Camera) -> pxr.UsdGeom.Camera:
    pass
@typing.overload
def defineCapsule(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Capsule:
    """
    ...
    """
@typing.overload
def defineCapsule(parent: pxr.Usd.Prim, name: str, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Capsule:
    pass
@typing.overload
def defineCapsule(prim: pxr.Usd.Prim, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Capsule:
    pass
@typing.overload
def defineCone(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cone:
    """
    ...
    """
@typing.overload
def defineCone(parent: pxr.Usd.Prim, name: str, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cone:
    pass
@typing.overload
def defineCone(prim: pxr.Usd.Prim, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cone:
    pass
@typing.overload
def defineCube(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, size: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cube:
    """
    ...
    """
@typing.overload
def defineCube(parent: pxr.Usd.Prim, name: str, size: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cube:
    pass
@typing.overload
def defineCube(prim: pxr.Usd.Prim, size: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cube:
    pass
@typing.overload
...
def defineCubicBasisCurves(prim: pxr.Usd.Prim, curveVertexCounts: pxr.Vt.IntArray, points: pxr.Vt.Vec3fArray, basis: str = 'bezier', wrap: str = 'nonperiodic', widths: typing.Optional[FloatPrimvarData] = None, normals: typing.Optional[Vec3fPrimvarData] = None, displayColor: typing.Optional[Vec3fPrimvarData] = None, displayOpacity: typing.Optional[FloatPrimvarData] = None) -> pxr.UsdGeom.BasisCurves:
    pass
@typing.overload
def defineCylinder(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cylinder:
    """
    ...
    """
@typing.overload
def defineCylinder(parent: pxr.Usd.Prim, name: str, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cylinder:
    pass
@typing.overload
def defineCylinder(prim: pxr.Usd.Prim, radius: float, height: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Cylinder:
    pass
@typing.overload
...
def definePhysicsSphericalJoint(prim: pxr.Usd.Prim, body0: pxr.Usd.Prim, body1: pxr.Usd.Prim, frame: JointFrame, axis: pxr.Gf.Vec3f, coneAngle0Limit: typing.Optional[float] = None, coneAngle1Limit: typing.Optional[float] = None) -> pxr.UsdPhysics.SphericalJoint:
    pass
@typing.overload
def definePlane(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, width: float, length: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Plane:
    """
    ...
    """
@typing.overload
def definePlane(parent: pxr.Usd.Prim, name: str, width: float, length: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Plane:
    pass
@typing.overload
def definePlane(prim: pxr.Usd.Prim, width: float, length: float, axis: str, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Plane:
    pass
@typing.overload
...
def defineScope(prim: pxr.Usd.Prim) -> pxr.UsdGeom.Scope:
    pass
@typing.overload
def defineSphere(stage: pxr.Usd.Stage, path: pxr.Sdf.Path, radius: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Sphere:
    """
    ...
    """
@typing.overload
def defineSphere(parent: pxr.Usd.Prim, name: str, radius: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Sphere:
    pass
@typing.overload
def defineSphere(prim: pxr.Usd.Prim, radius: float, displayColor: typing.Optional[pxr.Gf.Vec3f] = None, displayOpacity: typing.Optional[float] = None) -> pxr.UsdGeom.Sphere:
    pass
@typing.overload
